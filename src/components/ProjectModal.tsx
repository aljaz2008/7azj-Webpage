      ...
      {open ? (
        ...
        >
          <motion.div
            ...
            className="relative max-h-[88vh] w-full max-w-3xl overflow-y-auto rounded-2xl border border-border bg-card p-8"
          ...
          >
            ...
            <h3 className="mb-6 pr-16 font-heading text-3xl">{title}</h3>

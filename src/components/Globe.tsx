...
function GlobeMesh() {
  ...
  const globe = useMemo(() => {
    const instance = new ThreeGlobe({ waitForGlobeReady: true })
...
export default function Globe() {
  return (
    <div className="h-[280px] sm:h-[340px] md:h-[380px] w-full overflow-hidden rounded-2xl border border-border bg-card/60 shadow-glow">
